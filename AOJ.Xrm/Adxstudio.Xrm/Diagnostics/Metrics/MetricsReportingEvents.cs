...
namespace Adxstudio.Xrm.Diagnostics.Metrics
{
	...
	internal sealed class MetricsReportingEvents : EventSourceBase
	{
		...
		{
			WriteEvent((int)EventNames.MetricInitializationFailed, exception, portalUrl, portalVersion, portalProductionOrTrialType, sessionId, elapsedTime);
		}
		...
		{
			WriteEvent((int)EventNames.MetricReportingFailed, metricName, exception, portalUrl, portalVersion, portalProductionOrTrialType, sessionId, elapsedTime);
		}
	}
}
