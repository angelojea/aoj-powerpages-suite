...
namespace Adxstudio.Xrm.Web.UI.JsonConfiguration
{
	...
	{
		private static readonly string DefaultButtonLabel = "<span class='fa fa-check-square-o fa-fw' aria-hidden='true'></span> " + ResourceManager.GetString("Activate_Button_Text");
		private static readonly string DefaultButtonTooltip = ResourceManager.GetString("Activate_Button_Text");
