...
namespace Adxstudio.Xrm.Web.UI.JsonConfiguration
{
	...
	{
		private static readonly string DefaultButtonLabel = "<span class='fa fa-clipboard fa-fw' aria-hidden='true'></span> " + ResourceManager.GetString("Create_Order_Button_Text");
		private static readonly string DefaultButtonTooltip = ResourceManager.GetString("Create_Order_Button_Text");
