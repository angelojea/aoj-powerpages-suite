...
namespace Adxstudio.Xrm.Web.Mvc.Liquid
{
	public class EntityViewDrop : PortalDrop
	{
		...
		{
			get { return TotalPages > 0 ? 1 : null; }
		}
		...
		public int? LastPage
		{
			get { return TotalPages > 0 ? TotalPages : null; }
		}
		...
		public int? NextPage
		{
			get { return Page < TotalPages ? Page + 1 : null; }
		}
		...
		protected Lazy<ViewDataAdapter.FetchResult> FetchResult { get; }

		protected Lazy<EntityListViewDrop> View { get; }

		protected ViewConfiguration ViewConfiguration { get; }

		protected ViewDataAdapter ViewDataAdapter { get; }
	}
}
