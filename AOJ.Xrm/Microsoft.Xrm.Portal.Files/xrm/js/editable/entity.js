...
XRM.onActivate(function () {
    ...
    ns.createDeleteButton = function (entityContainer, entityDeleteUri, entityDisplayName, container) {
        return new YAHOO.widget.Button({
            ...
            onclick: {
                fn: function () {
                    ns.showDeletionDialog(entityContainer, entityDeleteUri, entityDisplayName);
                }
            }
        });
    }
    ...
    ns.showDeletionDialog = function (entityContainer, entityUri, entityDisplayName) {
        ...
        var dialog = new YAHOO.widget.SimpleDialog(dialogContainer.get(0), {
            ...
            buttons: [{
                text: XRM.localize('confirm.yes'),
                handler: handleYes,
                isDefault: true
            }, {text: XRM.localize('confirm.no'), handler: handleNo}]
        });
    ...
    ns.showEntityDialog = function (form, options) {
        ...
        function save() {
            ...
            $.each(fields, function (i, field) {
                field.appendData(data, dialog.body);
            });
        ...
        $.each(fields, function (i, field) {
            if (field.slugify) {
                var targets = $.grep(fields, function (f) {
                    return f.name == field.slugify
                });
        ...
        var fieldsToLoad = $.grep(fields, function (field) {
            return field.requiresLoading
        });
        ...
        XRM.data.postJSON(form.uri, data, {
            ...
            success: function (data, textStatus) {
                ...
                $.each(fileUploads, function (i, field) {
                    field.upload(data, function () {
                        fileUploadComplete(field)
                    });
                });
            },
