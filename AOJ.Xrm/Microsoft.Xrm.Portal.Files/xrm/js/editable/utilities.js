...
XRM.onActivate(function () {
    ...
    ns.slugify = function (value) {
        return value.replace(/^\s+/, ''). // Strip leading whitespace.
            replace(/\s+$/, ''). // Strip trailing whitespace.
            toLowerCase().replace(/[^-a-z0-9~\s\.:;+=_\/]/g, ''). // Strip chars that are not alphanumeric, or within a certain set of allowed punctuation.
