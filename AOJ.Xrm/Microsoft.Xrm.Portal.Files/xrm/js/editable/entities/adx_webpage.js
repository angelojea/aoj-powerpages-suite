...
XRM.onActivate(function () {
    ...
    self.formPrototype = {
        ...
        fields: [
            ...
            {
                name: 'adx_pagetemplateid',
                label: 'Page Template',
                type: 'select',
                excludeEmptyData: true,
                required: true,
                uri: null,
                optionEntityName: 'adx_pagetemplate',
                optionText: 'adx_name',
                optionValue: 'adx_pagetemplateid',
                sortby: 'adx_name'
            },
    ...
    self.createOptions = [
        {
            entityName: 'adx_webpage',
            relationship: 'adx_webpage_webpage_Referenced',
            label: 'entity.create.adx_webpage.label',
            title: 'entity.create.adx_webpage.tooltip',
            redirect: true
        },
        {
            entityName: 'adx_webfile',
            relationship: 'adx_webpage_webfile',
            label: 'entity.create.adx_webfile.label',
            title: 'entity.create.adx_webfile.tooltip',
            redirect: false
        }
    ];
