...
namespace Microsoft.Xrm.Portal.IdentityModel.Configuration
{
	...
	///    attributeMapInvitationCode="mspp_invitationcode"
	///    attributeMapInvitationCodeExpiryDate="mspp_invitationcodeexpirydate"
	///    attributeMapChallengeAnswer="mspp_passwordanswer"
	///    attributeMapLogonEnabled="mspp_logonenabled"
	///    attributeMapEmail="emailaddress1"
	///    attributeMapDisplayName="lastname"
	///    attributeMapLastSuccessfulLogon="mspp_lastsuccessfullogon"
	///    attributeMapIdentityProvider="mspp_identityprovider"
